...
const dict = {
  en: {
    ...
    runNextStepPaste: 'cannot run it where dsh lives? paste the error at https://dsh-why.com and get the same report',
  ...
  zh: {
    ...
    runNextStepPaste: '在 dsh 所在的机器上跑不了？把报错贴到 https://dsh-why.com，得到同一份报告',
